...
const UseReducerInFunc = () => {
  ...
  return (
    <>
      <p>
        syntext is usereducer hook: const [state, dispatch] =
        useReducer(reducerMethod, initialValue)
      </p>
      <p>
      ...
      <p>
        ...
        state, and the function to load the initial state lazily.
      </p>
      <p>
        <a href="https://youtu.be/TlSJVL3dvRM?si=zFxHmt2kbI3ChJx2">
          Usereducer hook videos
        </a>
        (yoshita jain)
      </p>
      <br />
